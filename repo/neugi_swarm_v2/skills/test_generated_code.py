...
from neugi_swarm_v2.skills.improver import SkillImprover, SkillImprovement
...
# Test execution
print("\n=== Execution Test ===")
globs = {"SkillAction": SkillAction, "SkillContract": SkillContract, "SkillTier": SkillTier}
try:
    exec(compiled, globs)
...
globs2 = {"SkillAction": SkillAction, "SkillContract": SkillContract, "SkillTier": SkillTier}
exec(compile(code2, "<test2>", "exec"), globs2)
