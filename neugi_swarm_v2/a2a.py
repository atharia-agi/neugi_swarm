...
class A2AProtocol:
    ...
    def register_agent(
        ...
        handler: Callable[[A2AMessage], A2AMessage | None] | None = None,
    ...
    def send(
        ...
        recipient_id: str,
        message: A2AMessage,
        callback: Callable[[A2AMessage], None] | None = None,
    ) -> A2AMessage | None:
        """
...
class A2AChannel:
    ...
    def send(self, recipient: str, task: str, payload: dict[str, Any] = None) -> A2AMessage | None:
