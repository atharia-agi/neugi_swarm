...
- **Test count:** 369 collected (367 passed, 2 optional browser tests skipped when Playwright is absent), all non-optional tests must pass
- **Version:** 2.1.3
...
│
├── tests/                    # 369 collected tests across all subsystems
...
# Expected: 367 passed, 2 skipped when Playwright is absent
```
